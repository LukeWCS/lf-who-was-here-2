...
class v_1_4_0 extends \phpbb\db\migration\migration
{
	...
	public function update_data()
	{
		return array(
			...
			array('permission.permission_set', array('ADMINISTRATORS', 'u_wwh_show_stats', 'group')),
			array('permission.permission_set', array('GLOBAL_MODERATORS', 'u_wwh_show_users', 'group')),
			array('permission.permission_set', array('GLOBAL_MODERATORS', 'u_wwh_show_stats', 'group')),
