...
$lang = array_merge($lang, array(
	...
	'WWH_DISP_HIDDEN_EXP'			=> 'In der Benutzerliste werden auch unsichtbare Benutzer angezeigt. (Benötigt Berechtigung)',
	'WWH_DISP_TIME'					=> 'Zeige die Zeit von Benutzern',
	'WWH_DISP_TIME_EXP'				=> '“Bei überfahren” zeigt zusätzlich ein Zeit-Symbol an, mit dem die Zeiten auch direkt eingeblendet werden können. Hilfreich bei Smartphones und Tablet PCs. (Allen Benutzern zeigen oder niemandem, keine spezielle Funktion für Administratoren.)',
	...
	'WWH_SORT_BY_EXP'				=> 'Damit wird die Reihenfolge festgelegt, in der die Benutzer angezeigt werden. (Eine Änderung dieser Einstellung gilt für die nächste Aktualisierung, die alle %s Minuten stattfindet.)',
