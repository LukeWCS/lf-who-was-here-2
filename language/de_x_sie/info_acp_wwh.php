...
$lang = array_merge($lang, array(
	...
	'WWH_UPDATE_NEED'			=> 'Aktualisieren Sie die "Wer War Da?" Erweiterung. Führen Sie dazu die <a style="font-weight: bold;" href="' . $phpbb_root_path . 'install/index.php">install/index.php</a> aus.<br />Wenn Sie das getan haben, sollten Sie das install/ Verzeichnis wieder entfernen.',
	...
	'WWH_VERSION2_EXP2'			=> 'deaktiviert, wenn Sie "Heute" gewählt haben',
	'WWH_VERSION2_EXP3'			=> 'Sekunden',


	'WWH_MOD'				=> '"Who was here?" Erweiterung',
	'INSTALL_WWH_MOD'			=> '"Who was here?" Erweiterung installieren',
	'INSTALL_WWH_MOD_CONFIRM'		=> 'Sind Sie sicher, dass Sie die "Who was here?" Erweiterung installieren möchten?',
	'UPDATE_WWH_MOD'			=> '"Who was here?" Erweiterung aktualisieren',
	'UPDATE_WWH_MOD_CONFIRM'		=> 'Sind Sie sicher, dass Sie die "Who was here?" Erweiterung aktualisieren möchten?',
	'UNINSTALL_WWH_MOD'			=> '"Who was here?" Erweiterung deinstallieren',
	'UNINSTALL_WWH_MOD_CONFIRM'		=> 'Sind Sie sicher, dass Sie die "Who was here?" Erweiterung deinstallieren möchten?',
));
